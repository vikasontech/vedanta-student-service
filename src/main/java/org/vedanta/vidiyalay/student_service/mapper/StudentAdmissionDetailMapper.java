...
public interface StudentAdmissionDetailMapper {

    StudentNewAdmissionVM toVm(StudentNewAdmissionEntity entity);

    StudentNewAdmissionEntity toEntity(StudentNewAdmissionVM vm);
}
